...
| `select` | `items.csv`, `people.csv`, `flags.csv`, the config (`[family] gate`, `[show] off_limits` and `must_include`, `[pins]`) | `index/selection.csv`, `index/cut-list.csv` | `--lens v1..v4`, `--include-undated`, `--allow-presence-gate` |
