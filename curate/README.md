...
|---|---|---|---|
| `ingest` | the `[[sources]]` in the config | `work/`, `index/ingest.csv`, `index/takeout-sidecars.csv` (sidecars inside Takeout zips, and the Takeout JSON and `.xmp` sidecars beside files in folder sources) | `--workers N` |
