...
- **Never open a photo.** Claude does not open a photo, a tile, a frame or a contact-sheet image with an image-reading tool, and works from the index, the flags and what the owner says instead. The owner's eyes decide what a picture shows, and the pixels stay on the machine.
